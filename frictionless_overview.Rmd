...
[Types](https://specs.frictionlessdata.io/table-schema/#types-and-formats) - describes what kind of field is in the table using a controlled vocabular. Default is type string. See also [Rich Type](https://specs.frictionlessdata.io/table-schema/#rich-types)
...
Finally, validate your data package. The [validation tools](https://framework.frictionlessdata.io/docs/getting-started.html) are available in python and via the command line. 
